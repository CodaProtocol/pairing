...
impl Engine for Mnt4 {
        ...
        >,
    {
        ...
        fn ell(f: &mut Fq4, coeffs: &(Fq2, Fq2, Fq2), p: &G1Affine) {
            let mut c0 = coeffs.0;
            let mut c1 = coeffs.1;
    ...
    fn final_exponentiation(r: &Fq4) -> Option<Fq4> {
        let mut f1 = *r;
        f1.conjugate();
...
fn mnt4_engine_tests() {
    ::tests::engine::engine_tests::<Mnt4>();
}
